...
import { ArrowLeft, Mail, BookOpen, CalendarCheck } from "lucide-react";
...
export default async function TeacherStudentDetailPage({
  ...
  const { data: student } = await supabase
    .from("students")
    .select(
      "id, roll_no, semester, batch, section, created_at, profiles(full_name, email), departments(name, full_name)"
    )
    .eq("id", id)
    .single();
